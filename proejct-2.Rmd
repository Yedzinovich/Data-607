...
```
## Data analysis:
1 - Overall distribution of ethnicity
...
2 - Between State Comparison 
Compare the integration levels of different ethnic groups between states to see which states are more integrated.
